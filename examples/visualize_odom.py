...
def main():
    # Load csv files
    gt_drone_data = OdometryData.from_csv('/media/dbutterfield3/T75/Hercules_datasets/V1.2/extract/Husky2_odomGT.csv', 'Husky2/odom_local', 'Husky2/base_link', CoordinateFrame.ROS)
    noisy_drone_data = OdometryData.from_csv('/media/dbutterfield3/T75/Hercules_datasets/V1.2/extract/Husky2_odomGTNoisy.csv',
                                       'Husky2/odom_local', 'Husky2/base_link', CoordinateFrame.ROS)
    gt_Husky_data = OdometryData.from_csv('/media/dbutterfield3/T75/Hercules_datasets/V1.2/extract/Husky1_odomGT.csv', 'Husky1/odom_local', 'Husky1/base_link', CoordinateFrame.ROS)
    noisy_Husky_data = OdometryData.from_csv('/media/dbutterfield3/T75/Hercules_datasets/V1.2/extract/Husky1_odomGTNoisy.csv',
                                       'Husky1/odom_local', 'Husky1/base_link', CoordinateFrame.ROS)
