...
def main():
    ...
    odom_data = OdometryData.from_txt_file('/media/dbutterfield3/T73/Hercules_datasets/V1.4.1/data/' + robot_name + '/odom.txt', robot_name + '/odom', robot_name + '/ground_truth/base_link', CoordinateFrame.NED)
